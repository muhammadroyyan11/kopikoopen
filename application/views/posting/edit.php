                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="first-name" class="form-control" name="judul" value="<?= $this->input->post('judul') ?? $row->judul ?>" placeholder="Judul Artikel">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="konten" class="form-control" id="ckeditor" cols="80" rows="10"><?= $this->input->post('konten') ?? $row->konten ?> </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select type="password" name="featured" value="<?= set_value('featured') ?? $row->featured ?>" class="form-control">
